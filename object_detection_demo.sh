...
gst-launch-1.0 \
    ...
    videoconvert ! videoscale ! videorate ! video/x-raw,width=640,height=480,framerate=30/1 ! \
    tee name=t \
    ...
    tensor_decoder mode=bounding_boxes option1=yolov8 option2=coco.txt option4=640:480 option5=320:320 ! \
